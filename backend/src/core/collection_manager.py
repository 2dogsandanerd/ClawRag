...
class CollectionManager:
    ...
    async def create_collection(
        ...
        try:
            ...
            embedding_provider = embedding_config.get("provider", "ollama") if embedding_config else "ollama"
            embedding_model = embedding_config.get("model", "nomic-embed-text:latest") if embedding_config else "nomic-embed-text:latest"
