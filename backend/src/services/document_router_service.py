    ...
    def _make_routing_decision(self, classification_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for rule in self.routing_rules.get("rules", []):
            ...
            decision = {
                ...
                "processing_params": {
                    ...
                    "embedding_model": action.get("embedding_model", "nomic-embed-text"),
        ...
        decision = {
            ...
            "processing_params": {
                ...
                "embedding_model": classification_result.get("suggested_embedding_model", defaults.get("embedding_model", "nomic-embed-text")),
